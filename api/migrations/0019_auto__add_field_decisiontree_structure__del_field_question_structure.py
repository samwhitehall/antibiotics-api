...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Question.structure'
        db.delete_column(u'api_question', 'structure')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Question.structure'
        db.add_column(u'api_question', 'structure',
                      self.gf('jsonfield.fields.JSONField')(default='', blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'api.decisiontree': {
            ...
            'structure': ('jsonfield.fields.JSONField', [], {'blank': 'True'})
        },
        u'api.diagnosis': {
