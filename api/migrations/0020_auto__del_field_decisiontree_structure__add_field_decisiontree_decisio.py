...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DecisionTree.structure'
        db.delete_column(u'api_decisiontree', 'structure')

        # Adding field 'DecisionTree.decision_structure'
        db.add_column(u'api_decisiontree', 'decision_structure',
                      self.gf('jsonfield.fields.JSONField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DecisionTree.structure'
        db.add_column(u'api_decisiontree', 'structure',
                      self.gf('jsonfield.fields.JSONField')(default='', blank=True),
                      keep_default=False)

        # Deleting field 'DecisionTree.decision_structure'
        db.delete_column(u'api_decisiontree', 'decision_structure')
