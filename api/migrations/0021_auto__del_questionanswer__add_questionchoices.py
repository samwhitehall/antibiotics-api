...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'QuestionChoices'
        db.create_table(u'api_questionchoices', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=10)),
        ))
        db.send_create_signal(u'api', ['QuestionChoices'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'QuestionChoices'
        db.delete_table(u'api_questionchoices')
    ...
    models = {
        ...
        u'api.question': {
            ...
            'answers': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['api.QuestionChoices']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'api.questionchoices': {
            'Meta': {'object_name': 'QuestionChoices'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
