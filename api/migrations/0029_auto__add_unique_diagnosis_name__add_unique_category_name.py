...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Diagnosis', fields ['name']
        db.create_unique(u'api_diagnosis', ['name'])

        # Adding unique constraint on 'Category', fields ['name']
        db.create_unique(u'api_category', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Category', fields ['name']
        db.delete_unique(u'api_category', ['name'])

        # Removing unique constraint on 'Diagnosis', fields ['name']
        db.delete_unique(u'api_diagnosis', ['name'])
